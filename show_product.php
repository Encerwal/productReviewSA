                            ...
                            <div class='pagination'>
                                ...
                                <div class='filter-controls'>
                                    <div class='dropdown-wrapper'>
                                        <select id='sentiment-filter' class='filter-dropdown'>
                                            <option value='all' disabled selected>Filter by Sentiment</option>
                                    ...
                                    <div class='dropdown-wrapper'>
                                        <select id='category-filter' class='filter-dropdown'>
                                            <option value='all' disabled selected>Filter by Category</option>
...
<script>
    ...
    function updateClassBasedOnResolution() {
        ...
        //pagination function and filter function:
        let currentPage = 1;
        let totalPages = 1;
        ...
        function fetchData(page, sentiment = 'all', category = 'all') {
            const xhr = new XMLHttpRequest();
            xhr.open('GET', `get_data.php?page=${page}&sentiment=${sentiment}&category=${category}`, true);
            xhr.onload = function() {
                if (this.status === 200) {
        ...
        prevBtn.addEventListener('click', function() {
            if (currentPage > 1) {
                currentPage--;
                fetchData(currentPage, sentimentFilter.value, categoryFilter.value);
            }
        });
        ...
        sentimentFilter.addEventListener('change', function() {
            fetchData(1, this.value, categoryFilter.value); // Fetch data from page 1 when sentiment changes
        });

        categoryFilter.addEventListener('change', function() {
            fetchData(1, sentimentFilter.value, this.value); // Fetch data from page 1 when category changes
        });
